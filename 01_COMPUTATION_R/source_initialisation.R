...
conv$ICfrac           <- 0.75   
conv$sim_lyr_thickness<- 5             #cm simulation layer thickness
...
k$kyear.v    <- 1# 15:25                              # 1:30    # the thirty years 1:30
k$ksite.v    <- 2 # c(9, 10, 14, 17, 31:34)   # the number of sites 1:34, k$ksite.v <- 1:nrow(data$fnames)
