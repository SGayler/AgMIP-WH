...
#define TITLE_PLANT_LINE_2 "  Date \t   Dev\t  LAI \t num_P/T\t Root_d\t   Root_BM\t Vag_BM\t gen_BM\t BM_t \t N_Root\t N_agBM\t N_gBM\t c_NUpt\t %N_Root\t %N_agBM\t %N_gBM\t d_NUpt\t d_potT\t d_actT\t c_actT"
...
#define TITLE_PLANT_20  "(20) Cum. Act. Transpiration                  [mm]        [###.##]"
...
#define TITLE_DAISY_LINE_1 " (1)\t(2)\t(3)\t(4)\t(5)\t(6)\t(7)\t(8)\t(9)\t(10)\t(11)\t(12)\t(13)\t(14)\t(15)\t(16)\t(17)\t(18)\t(19)\t(20)\t(21)\t(22)\t(23)\t(24)\t(25)\t(26)\t(27)\t(28)\t(29)\t(30)\t(31)\t(32)\t(33)"
#define TITLE_DAISY_LINE_2 " Date\tC_SOM1_30\tC_SOM1_60\tC_SOM1_90\tN_SOM1_30\tN_SOM1_60\tN_SOM1_90\tC_SOM1\tN_SOM1\tC_SOM2_30\tC_SOM2_60\tC_SOM2_90\tN_SOM2_30\tN_SOM2_60\tN_SOM2_90\tC_SOM2\tN_SOM2\tC_BOM1_30\tC_BOM1_60\tC_BOM1_90\tN_BOM1_30\tN_BOM1_60\tN_BOM1_90\tC_BOM1\tN_BOM1\tC_BOM2_30\tC_BOM2_60\tC_BOM2_90\tN_BOM2_30\tN_BOM2_60\tN_BOM2_90\tC_BOM2\tN_BOM2"

//#define TITLE_DAISY_LINE_1 "  Test1"
//#define TITLE_DAISY_LINE_2 "  Test2"

#define TITLE_DAISY_1   "(1)  Date                                       [DDMMYY]"
#define TITLE_DAISY_2   "(2)  C in HumusSlow (SOM1) in  0- 30cm Depth    [kg C/ha] [###.##]"
#define TITLE_DAISY_4   "(3)  C in HumusSlow (SOM1) in 30- 60cm Depth    [kg C/ha] [###.##]"
#define TITLE_DAISY_6   "(4)  C in HumusSlow (SOM1) in 60- 90cm Depth    [kg C/ha] [###.##]"
#define TITLE_DAISY_3   "(5)  N in HumusSlow (SOM1) in  0- 30cm Depth    [kg N/ha] [###.##]"
#define TITLE_DAISY_5   "(6)  N in HumusSlow (SOM1) in 30- 60cm Depth    [kg N/ha] [###.##]"
#define TITLE_DAISY_7   "(7)  N in HumusSlow (SOM1) in 60- 90cm Depth    [kg N/ha] [###.##]"
#define TITLE_DAISY_8   "(8)  Carbon Content in SOM1 (Profile)           [kg C/ha] [###.##]"
#define TITLE_DAISY_9   "(9)  Nitrogen Content in SOM1 (Profile)         [kg N/ha] [###.##]"
#define TITLE_DAISY_10  "(10) C in HumusFast (SOM2) in  0- 30cm Depth    [kg C/ha] [###.##]"
#define TITLE_DAISY_12  "(11) C in HumusFast (SOM2) in 30- 60cm Depth    [kg C/ha] [###.##]"
#define TITLE_DAISY_14  "(12) C in HumusFast (SOM2) in 60- 90cm Depth    [kg C/ha] [###.##]"
#define TITLE_DAISY_11  "(13) N in HumusFast (SOM2) in  0- 30cm Depth    [kg N/ha] [###.##]"
#define TITLE_DAISY_13  "(14) N in HumusFast (SOM2) in 30- 60cm Depth    [kg N/ha] [###.##]"
#define TITLE_DAISY_15  "(15) N in HumusFast (SOM2) in 60- 90cm Depth    [kg N/ha] [###.##]"
#define TITLE_DAISY_16  "(16) Carbon Content in SOM2 (Profile)           [kg C/ha] [###.##]"
#define TITLE_DAISY_17  "(17) Nitrogen Content in SOM2 (Profile)         [kg N/ha] [###.##]"
#define TITLE_DAISY_18  "(18) C in MicBiomSlow (BOM1) in  0- 30cm Depth  [kg C/ha] [###.##]"
#define TITLE_DAISY_20  "(19) C in MicBiomSlow (BOM1) in 30- 60cm Depth  [kg C/ha] [###.##]"
#define TITLE_DAISY_22  "(20) C in MicBiomSlow (BOM1) in 60- 90cm Depth  [kg C/ha] [###.##]"
#define TITLE_DAISY_19  "(21) N in MicBiomSlow (BOM1) in  0- 30cm Depth  [kg N/ha] [###.##]"
#define TITLE_DAISY_21  "(22) N in MicBiomSlow (BOM1) in 30- 60cm Depth  [kg N/ha] [###.##]"
...
#define TITLE_DAISY_28  "(27) C in MicBiomFast (BOM2) in 30- 60cm Depth  [kg C/ha] [###.##]"
#define TITLE_DAISY_30  "(28) C in MicBiomFast (BOM2) in 60- 90cm Depth  [kg C/ha] [###.##]"
#define TITLE_DAISY_27  "(29) N in MicBiomFast (BOM2) in  0- 30cm Depth  [kg N/ha] [###.##]"
#define TITLE_DAISY_29  "(30) N in MicBiomFast (BOM2) in 30- 60cm Depth  [kg N/ha] [###.##]"
